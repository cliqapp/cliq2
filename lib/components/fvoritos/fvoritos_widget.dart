...
class FvoritosWidget extends StatefulWidget {
  const FvoritosWidget({Key? key}) : super(key: key);

  @override
  _FvoritosWidgetState createState() => _FvoritosWidgetState();
}
                          ...
                          decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                              ...
                              image: CachedNetworkImageProvider(
                                'https://meishop-dicasmei-uploads.s3.amazonaws.com/wp-content/uploads/2021/08/Diarista.png',
                              ),
                            ),
                            boxShadow: [
                              BoxShadow(
                        ...
                        AuthUserStreamWidget(
                          builder: (context) => Builder(
                            builder: (context) {
                              ...
                              return Column(
                                mainAxisSize: MainAxisSize.max,
                                children: List.generate(tes.length, (tesIndex) {
                                  final tesItem = tes[tesIndex];
                                  return Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        10.0, 10.0, 10.0, 0.0),
                                    child: InkWell(
