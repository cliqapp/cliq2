  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<EmpresasRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final perfilEmpresaEmpresasRecord = snapshot.data!;
                              ...
                              child: ClipRRect(
                                ...
                                child: Image.network(
                                  valueOrDefault<String>(
                                    perfilEmpresaEmpresasRecord.logo,
                                      ...
                                      Padding(
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            ...
                                            Expanded(
                                              child: Text(
                                                perfilEmpresaEmpresasRecord.rua,
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .bodyMedium
                                                        .override(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  final iconButtonConversasRecord =
                                      iconButtonConversasRecordList.isNotEmpty
                                          ? iconButtonConversasRecordList.first
                                          : null;
                                    ...
                                    onPressed: () async {
                                      if (iconButtonConversasRecord != null) {
                                        ...
                                        await conversasRecordReference
                                          ...
                                          idconversa: random_data.randomString(
                                            1,
                                            10,
                                            true,
                                            false,
                              ...
                              child: StreamBuilder<List<ProfissionaisRecord>>(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  return ListView.separated(
                                    ...
                                    itemCount:
                                        listViewProfissionaisRecordList.length,
                            ...
                            Expanded(
                              child: TabBarView(
                                ...
                                children: [
                                  ...
                                  StreamBuilder<List<ServicoPacotesRecord>>(
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      List<ServicoPacotesRecord>
                                          ...
                                          snapshot.data!;
                                      if (listViewServicoPacotesRecordList
                                          .isEmpty) {
                                        return Center(
                                          child: Image.asset(
                                            'assets/images/1200px-OOjs_UI_icon_cancel-destructive.svg.png',
                                            width: 100.0,
                                          ),
                                        );
                                      }
                                                          ...
                                                          children: [
                                                            ...
                                                            Padding(
                                                              ...
                                                              child: Row(
                                                                ...
                                                                children: [
                                                                  Text(
                                                                    'Duração: ${listViewServicoPacotesRecord.minutosGastos.toString()}min',
                                                                    style: FlutterFlowTheme.of(
                                                                            context)
                                                                        .bodyMedium
                                                                        .override(
                                  ...
                                  Padding(
                                    ...
                                    child: Builder(
                                      builder: (context) {
                                        final fotosempresa =
                                            perfilEmpresaEmpresasRecord.fotos
                                                .toList();
                                        return GridView.builder(
                                          ...
                                          scrollDirection: Axis.vertical,
                                          itemCount: fotosempresa.length,
                                          itemBuilder:
                                              (context, fotosempresaIndex) {
                                            final fotosempresaItem =
                                                fotosempresa[fotosempresaIndex];
                                            return Container(
                                              width: 100.0,
                                              height: 100.0,
                                              decoration: BoxDecoration(
