        ...
        body: AuthUserStreamWidget(
          builder: (context) => StreamBuilder<EnderecosUserRecord>(
            ...
            builder: (context, snapshot) {
              ...
              final stackEnderecosUserRecord = snapshot.data!;
              return Stack(
                children: [
                  Padding(
                    padding:
                          ...
                          Align(
                            ...
                            child: Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  if (currentUserDocument?.refendereco != null)
                                    StreamBuilder<EnderecosUserRecord>(
                                      stream: EnderecosUserRecord.getDocument(
                                          currentUserDocument!.refendereco!),
                                      builder: (context, snapshot) {
                                        // Customize what your widget looks like when it's loading.
                                        ...
                                        return InkWell(
                                          ...
                                          child: Text(
                                            valueOrDefault<String>(
                                              textEnderecosUserRecord.ruanumero,
                                              'sem end selecionado',
                                            ),
                                      ...
                                      return SingleChildScrollView(
                                        ...
                                        child: Row(
                                          ...
                                          children: List.generate(
                                              rowCategoriasRecordList.length,
                                              (rowIndex) {
                                                  ...
                                                  ClipRRect(
                                                    ...
                                                    child: CachedNetworkImage(
                                                      ...
                                                      imageUrl: valueOrDefault<
                                                        ...
                                                        rowCategoriasRecord
                                                            .fotoLogo,
                                                        'https://www.camarasaltodojacui.rs.gov.br/wp-content/uploads/2019/05/trabalhador-feliz-png-4.png',
                                                      ),
                                                      width: 80.0,
                                                      height: 80.0,
                                                      fit: BoxFit.cover,
                            ...
                            child: Container(
                              ...
                              child: Padding(
                                ...
                                child: PagedListView<DocumentSnapshot<Object?>?,
                                  ...
                                  scrollDirection: Axis.horizontal,
                                  builderDelegate:
                                      PagedChildBuilderDelegate<EmpresasRecord>(
                                    ...
                                    itemBuilder: (context, _, listViewIndex) {
                                      final listViewEmpresasRecord = _model
                                                              ...
                                                              child: Container(
                                                                ...
                                                                child: StreamBuilder<
                                                                  ...
                                                                  builder: (context,
                                                                    ...
                                                                    return Stack(
                                                                      children: [
                                                                        if ((currentUserDocument?.favoritos?.toList() ?? []).contains(listViewEmpresasRecord.reference) ==
                                                                            false)
                                                                          FlutterFlowIconButton(
                                                                            ...
                                                                            onPressed:
                                                                                () async {
                                                                              await stackUsersRecord.reference.update({
                                                                                ...mapToFirestore(
                                                                                  {
                  ...
                  Align(
                    ...
                    child: wrapWithModel(
                      ...
                      child: NavBarWithMiddleButtonWidget(
                        iconColorAtivo: Color(0xFF005DD9),
                        iconColor2: Color(0xFF9299A1),
